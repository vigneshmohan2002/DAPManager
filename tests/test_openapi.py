...
EXPECTED_API_ROUTES = {
    ...
    ("/api/downloads/<int:item_id>/attempts", "get_download_attempts", ("GET",)),
    ("/api/downloads/clear-completed", "clear_completed_downloads", ("POST",)),
    ("/api/downloads/list", "get_downloads_list", ("GET",)),
    ("/api/downloads/worker", "get_download_worker", ("GET",)),
    ("/api/downloads/worker/pause", "pause_download_worker", ("POST",)),
    ("/api/downloads/worker/resume", "resume_download_worker", ("POST",)),
